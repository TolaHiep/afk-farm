...
## Liên kết & trạng thái
- Kế hoạch triển khai chi tiết: `docs/superpowers/plans/2026-06-14-akf-gd1-implementation.md` (14 gói phát triển = 48 công, + 2 công quản lý/nghiệm thu = 50 công).
- Báo giá đã chốt: 50 công × 500.000đ = **25.000.000đ** (chưa VAT), bản trình bày `Downloads/AKF_Bao-gia_Giai-doan-1.docx`.
- Nền tảng: ERPNext v15 + custom app `akf_farm`; giao diện đặc thù (bản đồ ranh giới/nhiệt, lịch 10 ngày, PWA tổ trưởng) viết thêm.
- Trạng thái: spec + plan đã sẵn sàng; chờ thông tin Nhóm A của chủ đầu tư và 6 câu hỏi còn mở để khởi công Gói 1.
